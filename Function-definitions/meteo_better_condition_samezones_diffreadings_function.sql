CREATE OR REPLACE NONEDITIONABLE FUNCTION "C##METEO"."METEO_BETTER_CONDITION_SAMEZONES_DIFFREADINGS_FUNC" (obiekt1 METEO_T, obiekt2 METEO_T,x_pos NUMBER, y_pos NUMBER) RETURN NUMBER
IS
    komorka NUMBER;
    retval NUMBER;
BEGIN
    ...
    END IF;
    return retval;
END meteo_better_condition_samezones_diffreadings_func;
