CREATE OR REPLACE NONEDITIONABLE FUNCTION "C##METEO"."METEO_GREATERTHAN_ONE_PARAMETER_ANY_FUNC" (obiekt METEO_T, wartosc NUMBER, parametr VARCHAR2, starttime TIMESTAMP DEFAULT NULL,endtime TIMESTAMP DEFAULT NULL) return number
IS
    retval NUMBER:=0;
    indeks NUMBER;
    x_cord NUMBER;
...
BEGIN
    ...
    END LOOP;        
    return retval;
END meteo_greaterthan_one_parameter_any_func;
