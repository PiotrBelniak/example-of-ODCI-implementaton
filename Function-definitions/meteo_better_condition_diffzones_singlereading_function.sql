CREATE OR REPLACE NONEDITIONABLE FUNCTION "C##METEO"."METEO_BETTER_CONDITION_DIFFZONES_SINGLEREADING_FUNC" (obiekt METEO_T, x_pos1 NUMBER, y_pos1 NUMBER, x_pos2 NUMBER, y_pos2 NUMBER) RETURN NUMBER
IS
    komorka1 NUMBER;
    komorka2 NUMBER;
    retval NUMBER;
BEGIN
    ...
    END IF;
    return retval;
END meteo_better_condition_diffzones_singlereading_func;
