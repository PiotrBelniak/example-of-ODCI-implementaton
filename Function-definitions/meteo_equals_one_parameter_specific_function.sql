CREATE OR REPLACE NONEDITIONABLE FUNCTION "C##METEO"."METEO_EQUALS_ONE_PARAMETER_SPECIFIC_FUNC" (obiekt METEO_T, x_pos NUMBER, y_pos NUMBER, wartosc NUMBER, parametr VARCHAR2, starttime TIMESTAMP DEFAULT NULL,endtime TIMESTAMP DEFAULT NULL) return number
IS
    retval NUMBER;
BEGIN
    CASE UPPER(parametr)
        ...
        END CASE;
    return retval;
END meteo_equals_one_parameter_specific_func;
